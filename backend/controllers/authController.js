  ...
  try {
    res.json({
      user: {
        ...
        createTabs: req.user.createTabs || [],
        deleteTabs: req.user.deleteTabs || [],
...
exports.updateUser = async (req, res) => {
  try {
    ...
    if (createTabs !== undefined) user.createTabs = createTabs;
    if (deleteTabs !== undefined) user.deleteTabs = deleteTabs;
