    ...
    <>
      ...
      <div
        style={{
          ...
          borderRadius: 20,
          boxShadow: `0 0 0 1px ${c.border}, 0 24px 60px rgba(27,39,68,0.15), 0 0 40px ${c.bgGlow}`,
          overflow: "hidden",
          animation: exiting
            ? "alertScaleOut 0.28s ease forwards"
      ...
      >
        ...
        <div style={{ padding: "28px 28px 20px", textAlign: "center" }}>
          ...
          <div
            style={{
              ...
              position: "relative",
              animation:
                "iconPop 0.4s cubic-bezier(0.34,1.56,0.64,1) 0.1s both",
            }}
          >
            <div
              style={{
        ...
        <div
          style={{
            height: 3,
            background: "rgba(180,195,215,0.25)",
            width: "100%",
          }}
        >
          <div
...
export function ExcelImportBtn({
  ...
  const downloadTemplate = () => {
    const examples =
      templateRows && templateRows.length > 0 ? templateRows : [];
    const data =
      examples.length > 0
        ? examples
