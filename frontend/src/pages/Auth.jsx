...
const API = import.meta.env.VITE_API_URL ||"http://localhost:2500/api";
...
function ErrorToast({ message, onClose }) {
 ...
 <path fillRule="evenodd"d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z"clipRule="evenodd" /></svg>
 </div>
 {/* text */}
 ...
 <p style={{ margin:"2px 0 0", fontSize: 13, color:"#94a3b8", lineHeight: 1.5 }}>
 {message}
 </p>
 </div>
 {/* close */}
 ...
 color:"#94a3b8", padding: 2, lineHeight: 1, borderRadius: 4,
 }}
 >
...
export function LoginScreen() {
 ...
 width:"100%",
 background: disabled ?"rgba(99,102,241,0.3)": C.accent,
 color:"#fff",
 border:"none",
 borderRadius: 12,
 padding:"12px 16px",
 ...
 <div style={{ background:"rgba(239,68,68,0.1)", color:"#f87171", border:"1px solid rgba(239,68,68,0.2)", borderRadius: 10, padding:"10px 14px", fontSize: 13, marginBottom: 16 }}>
 {msg}
 </div>
 ) : null;

 const SuccessBox = ({ msg }) => msg ? (
 <div style={{ background:"rgba(34,197,94,0.1)", color:"#4ade80", border:"1px solid rgba(34,197,94,0.2)", borderRadius: 10, padding:"10px 14px", fontSize: 13, marginBottom: 16 }}>
 {msg}
 </div>
 ) : null;
 ...
 <i className="fa-solid fa-industry" style={{ fontSize: 40, color: C.accent, marginBottom: 12, display:"block" }} />
 ...
 return (
 <div style={{ height:"100vh", display:"flex", alignItems:"center", justifyContent:"center", background:"linear-gradient(135deg, #07070f 0%, #0c0c1a 50%, #09090e 100%)"}}>
