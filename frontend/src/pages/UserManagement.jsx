          ...
          >
            <div>
              ...
              <div style={{ fontSize: 11, color: "#666", marginTop: 2 }}>
                Excel & PDF import/export buttons across all pages
              </div>
            </div>
            <div
              onClick={() =>
                setForm((p) => ({
                  ...p,
                  allowExportImport: !p.allowExportImport,
                }))
              }
              style={{
                width: 40,
          ...
          >
            ...
            <div
              onClick={() =>
                setForm((p) => ({
                  ...p,
                  allowEditStock: !p.allowEditStock,
                }))
              }
              style={{
                width: 40,
                ...
                borderRadius: 11,
                cursor: "pointer",
                background: form.allowEditStock ? "#4CAF50" : "#444",
                position: "relative",
                transition: "background 0.2s",
                flexShrink: 0,
              }}
          ...
          return (
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  <span
                    style={{ fontWeight: 500, fontSize: 14, color: "#e0e0e0" }}
                  >
              ...
              <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
                ...
                >
                  <i
                    className={`fa-solid ${user.isActive ? "fa-pause" : "fa-play"}`}
                  />{" "}
